...
const completionHandler = (nativeModule: ModuleBase, fetchId: string) => (
  fetchResult: string
): Promise<void> =>
  getNativeModule(nativeModule).completionHandler(fetchId, fetchResult);
  ...
  constructor(app: App) {
    ...
    SharedEventEmitter.addListener(
      ...
      (notification: NativeNotification) => {
        ...
        const done = completionHandler(this, rnNotification.notificationId);
